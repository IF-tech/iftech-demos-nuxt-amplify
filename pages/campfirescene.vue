<template>
  <div>
    <v-container fluid style="position: absolute; z-index: 5"
      ><v-row> </v-row
    ></v-container>
...
export default {
  ...
  methods: {
    init: function () {
      ...
      const STUMP_PATH =
        'https://iftechpublicassets.s3.us-west-2.amazonaws.com/stumpandlaptop.glb'
      ...
      let TREE_PATH =
        'https://iftechpublicassets.s3.us-west-2.amazonaws.com/generictree.glb'
      loader.load(
        TREE_PATH,
        function (gltf) {
          // A lot is going to happen here
      ...
      const tick = () => {
        ...
        scene.background = new THREE.Color(this.backgroundColor)
        scene.fog = new THREE.Fog(this.backgroundColor, 60, 100)
        scene.children[4].material.color = new THREE.Color(this.backgroundColor)
